...
###
# Method 1. use ".."
# Lazy/smart/efficient way to do it
raw_inflow_data <- read.table(file="../Data/inflowtimeseries.txt",header=FALSE,skip=0)

# Method 2. use getwd()
# use this to find your working directory
getwd() 
# copy and paste the result below
raw_inflow_data <- read.table(file="/Users/stefanchen/Documents/Duke/Classes/Spring 2022/Time Series Analysis TA/ENV790_TimeSeriesAnalysis_Sp2022/Lessons/Data/inflowtimeseries.txt",header=FALSE,skip=0)
###
